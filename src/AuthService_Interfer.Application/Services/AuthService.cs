...
using AuthService_Interfer.Application.Interfaces;
using AuthService_Interfer.Application.Exceptions;
using AuthService_Interfer.Application.Extensions;
using AuthService_Interfer.Application.Validators;
using AuthService_Interfer.Domain.Constants;
using AuthService_Interfer.Domain.Entities;
using AuthService_Interfer.Domain.Interfaces;
using AuthService_Interfer.Domain.Enums;
using Microsoft.Extensions.Configuration;
using Microsoft.Extensions.Logging;
using AuthService_Interfer.Application.DTOs.Email;

namespace AuthService_Interfer.Application.Services;
    ...
    ILogger<AuthService> logger) : IAuthService
{
    ...
    public async Task<RegisterResponseDto> RegisterAsync(RegisterDto registerDto)
    {
        ...
        // Obtener el rol por defecto (ADMIN_ROLE) ya seedado en DB
        var defaultRole = await roleRepository.GetByNameAsync(RoleConstants.ADMIN_ROLE);
        if (defaultRole == null)
        {
            throw new InvalidOperationException($"Default role '{RoleConstants.ADMIN_ROLE}' not found. Ensure seeding runs before registration.");
        }
    ...
    {
        var userRole = user.UserRoles.FirstOrDefault()?.Role?.Name ?? RoleConstants.ADMIN_ROLE;
